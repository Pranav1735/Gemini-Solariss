      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-4 space-y-2">
              <button
                onClick={() => setActiveTab('profile')}
                className={`w-full text-left p-4 rounded-xl flex items-center space-x-3 transition-all duration-300 ${
                  activeTab === 'profile' 
              ...
              <Link
                to="/orders"
                className="w-full text-left p-4 rounded-xl flex items-center space-x-3 hover:bg-emerald-50 text-gray-700 transition-all duration-300"
              >
                <ShoppingBag />
          ...
          <div className="lg:col-span-3">
            {activeTab === 'profile' && (
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 animate-fadeInUp">
                <h2 className="text-3xl font-bold mb-6 text-emerald-700">Profile Information</h2>
                <form onSubmit={handleProfileSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={user.email}
                      disabled
                      className="w-full px-4 py-3 border-2 border-emerald-200 rounded-xl bg-emerald-50 text-gray-600"
                    />
                  </div>
                  ...
                  <button 
                    type="submit" 
                    className="w-full px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl font-bold text-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
                  >
                    Update Profile
                  </button>
                </form>
            ...
            {activeTab === 'password' && (
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 animate-fadeInUp">
                <h2 className="text-3xl font-bold mb-6 text-emerald-700">Change Password</h2>
